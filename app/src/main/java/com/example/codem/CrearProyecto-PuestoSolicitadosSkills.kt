...
fun MyPantalla12(navController: NavHostController) {
    CreateProjectSkillsPositions(navController)
}

@Composable
fun CreateProjectSkillsPositions(navController: NavHostController) {
